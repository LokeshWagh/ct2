...
function HeroSection() {
  ...
  return (
    ...
    >
      ...
      >
        The Future <br/> of Cattle Trading is Here!<span className="line"></span>
      </motion.h2>
...
/>
      ...
      ><span className="lok"></span>
        Experience a revolutionary AI-powered marketplace where buying and selling livestock is secure, seamless, and efficient.  
        Get real-time pricing, verified listings, and hassle-free transactions.  
        join now and step into the future of cattle trading!
        <center><div className="lok2"></div></center>
      </motion.p>
